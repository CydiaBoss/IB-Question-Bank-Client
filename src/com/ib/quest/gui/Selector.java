...
public class Selector {
	...
	private synchronized void topicSelection(HtmlAnchor anc) {
		...
		// Show
		main.getContentPane().add(topic = new Option(main, topicInt, subj, e -> {
			// Throw if No Select
	...
	private synchronized void quesSelection(int index) {
		...
		// TODO Play with Progress and try something wit SwingWorker
		// Background Stuff
		Thread bg = new Thread(() -> {
		...
		// Show
		main.getContentPane().add(quest = new Option(main, questInt, topic, e -> {
